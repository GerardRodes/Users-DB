...
Si clicamos sobre los roles de un usuario se nos permitirá asignar y desasignar roles, pero siempre teniendo en cuenta que cada usuario debe tener como mínimo un rol asignado.  
...
Clicando sobre el botón de `Add new user +` se nos mostrara la opción de crear un nuevo usuario, asignando un nombre y un mínimo de un rol.
